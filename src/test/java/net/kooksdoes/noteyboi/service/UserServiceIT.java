package net.kooksdoes.noteyboi.service;
...
import net.kooksdoes.noteyboi.config.Constants;
import net.kooksdoes.noteyboi.config.TestSecurityConfiguration;
import net.kooksdoes.noteyboi.domain.User;
import net.kooksdoes.noteyboi.repository.UserRepository;
import net.kooksdoes.noteyboi.repository.search.UserSearchRepository;
import net.kooksdoes.noteyboi.security.AuthoritiesConstants;
import net.kooksdoes.noteyboi.service.dto.UserDTO;
...
public class UserServiceIT {
    ...
    /**
     * This repository is mocked in the net.kooksdoes.noteyboi.repository.search test package.
     *
     * @see net.kooksdoes.noteyboi.repository.search.UserSearchRepositoryMockConfiguration
     */
    @Autowired
